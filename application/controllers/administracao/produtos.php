...
class Produtos extends CI_Controller {
	...
	public $nomeLista = "listaprodutos"; // nome do view  de listagem
	public $nomeModel = "produtos_model"; // nome do model
	public $nomeForm = "produtos";        // nome da view de cadastro
	public $nomeAltera = "alterar_produtos"; // nome da view de alterar
	public $temFoto = true;
	public $tabelaFoto = "fotos_produtos"; // nome da tabela de foto
	public $idFoto = "id_produtos";       // nome do campo da tabela de foto
	public $dentroDados = "produtos";     // nome que vai nos dados_
	public $nomeController = "produtos"; // nome do controlador
   ...
   function alterar($id) {
        ...
        $this->db->order_by("nome","asc");
        $data["categorias"] = $this->db->get("categoria")->result();
