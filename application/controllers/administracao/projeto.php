...
class Projeto extends CI_Controller {
	...
	public $nomeLista = "listaprojeto"; // nome do view  de listagem
	public $nomeModel = "projeto_model"; // nome do model
	public $nomeForm = "projeto";        // nome da view de cadastro
	public $nomeAltera = "alterar_projeto"; // nome da view de alterar
	public $temFoto = true;
	public $tabelaFoto = "fotos_projeto"; // nome da tabela de foto
	public $idFoto = "id_projeto";       // nome do campo da tabela de foto
	public $dentroDados = "projeto";     // nome que vai nos dados_
	public $nomeController = "projeto"; // nome do controlador
        ...
        if ($this->form_validation->run() == FALSE || $jaexiste == true) {  // Valida se os campos estao preenchidos e verifica se a foto ja existe
            ...
            $this->formcad($erro); // se o erro n for da foto chama o metodo sem o parametro de erro
                   ...
                   // TIAGO TESTE
					...
					$data['dormitorios']  = $this->input->post('dormitorios');
