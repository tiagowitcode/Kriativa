...
class Galeria extends CI_Controller {
	...
	public $nomeLista = "lista_galeria"; // nome do view  de listagem
	public $nomeModel = "galeria_model"; // nome do model
	public $nomeForm = "galeria";        // nome da view de cadastro
	public $nomeAltera = "alterar_galeria"; // nome da view de alterar
	public $temFoto = true;
	public $tabelaFoto = "fotos_galeria"; // nome da tabela de foto
	public $idFoto = "id_galeria";       // nome do campo da tabela de foto
	public $dentroDados = "galeria";     // nome que vai nos dados_
	public $nomeController = "galeria"; // nome do controlador
