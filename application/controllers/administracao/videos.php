...
class Videos extends CI_Controller {
	...
	public $nomeLista = "lista_videos"; // nome do view  de listagem
	public $nomeModel = "videos_model"; // nome do model
	public $nomeForm = "videos";        // nome da view de cadastro
	public $nomeAltera = "alterar_videos"; // nome da view de alterar
	public $temFoto = false;
	public $tabelaFoto = "fotos_videos"; // nome da tabela de foto
	public $idFoto = "id_videos";       // nome do campo da tabela de foto
	public $dentroDados = "videos";     // nome que vai nos dados_
	public $nomeController = "videos"; // nome do controlador
