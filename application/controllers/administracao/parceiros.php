...
class Parceiros extends CI_Controller {
	...
	public $nomeLista = "listaparceiros"; // nome do view  de listagem
	public $nomeModel = "parceiros_model"; // nome do model
	public $nomeForm = "parceiros";        // nome da view de cadastro
	public $nomeAltera = "alterar_parceiros"; // nome da view de alterar
	public $temFoto = true;
	public $tabelaFoto = "fotos_parceiros"; // nome da tabela de foto
	public $idFoto = "id_parceiros";       // nome do campo da tabela de foto
	public $dentroDados = "parceiros";     // nome que vai nos dados_
	public $nomeController = "parceiros"; // nome do controlador
