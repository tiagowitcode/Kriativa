...
class Categoria extends CI_Controller {
	...
	public $nomeLista = "lista_categoria"; // nome do view  de listagem
	public $nomeModel = "categoria_model"; // nome do model
	public $nomeForm = "categoria";        // nome da view de cadastro
	public $nomeAltera = "alterar_categoria"; // nome da view de alterar
	public $temFoto = false;
	public $tabelaFoto = "fotos_categoria"; // nome da tabela de foto
	public $idFoto = "id_categoria";       // nome do campo da tabela de foto
	public $dentroDados = "categoria";     // nome que vai nos dados_
	public $nomeController = "categoria"; // nome do controlador
