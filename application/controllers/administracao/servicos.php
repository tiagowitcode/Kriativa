...
class Servicos extends CI_Controller {
	...
	public $nomeLista = "lista_servicos"; // nome do view  de listagem
	public $nomeModel = "servicos_model"; // nome do model
	public $nomeForm = "servicos";        // nome da view de cadastro
	public $nomeAltera = "alterar_servicos"; // nome da view de alterar
	public $temFoto = true;
	public $tabelaFoto = "fotos_servicos"; // nome da tabela de foto
	public $idFoto = "id_servicos";       // nome do campo da tabela de foto
	public $dentroDados = "servicos";     // nome que vai nos dados_
	public $nomeController = "servicos"; // nome do controlador
